...
export const CHARACTERS: Character[] = [
  {
    ...
    ,
      'https://i.postimg.cc/PrXrf4D1/seoyuha-1.png',
      'https://i.postimg.cc/cL6xwLTF/seoyuha-2.png',
      'https://i.postimg.cc/HkjYXk3N/seoyuha-3.png',
      'https://i.postimg.cc/9QzmZQ1g/seoyuha-4.png',
      'https://i.postimg.cc/FH1r3HG8/seoyuha-5.png',
      'https://i.postimg.cc/nVvg6vSV/seoyuha-6.png'
    ],
    themeSongName: 'Smile for Me',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EC%84%9C%EC%9C%A0%ED%95%98%20-%20Smile%20for%20Me.mp3',
    ...
    relationships: [
      { targetId: 'park_doyoung', targetName: '박도영', thought: '유용한 개', quote: '내 명령을 완벽하게 수행하는 유용한 장기말. 곁에 두기 편해.' },
      { targetId: 'baek_hyunwoo', targetName: '백현우', thought: '거슬리는 거짓말', quote: '거짓으로 점철된 인간. 거슬리지만 아직은 쓸모가 있을지 지켜보는 중.' },
      { targetId: 'jung_haewoon', targetName: '정해운', thought: '흥미로운 실험체', quote: '괴물과 인간의 경계에 선 흥미로운 관찰 대상.' }
    ]
  },
  {
    id: 'park_doyoung',
    ...
    ,
      'https://i.postimg.cc/SxtKvMJj/bagdoyeong-1.png',
      'https://i.postimg.cc/0NMNRywp/bagdoyeong-2.png',
      'https://i.postimg.cc/25b5RSZn/bagdoyeong-3.png',
      'https://i.postimg.cc/mrzrfgHC/bagdoyeong-4.png',
      'https://i.postimg.cc/R0605ZH7/bagdoyeong-5.png',
      'https://i.postimg.cc/cJpLsG7q/bagdoyeong-6.png'
    ],
    themeSongName: '도련님',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EB%B0%95%EB%8F%84%EC%98%81%20-%20%EB%8F%84%EB%A0%A8%EB%8B%98.mp3',
    quote: '"도련님, 명령만 내리십시오."',
    info: [
      '나이: 32세',
      '신체: 182cm',
    ...
    relationships: [
      { targetId: 'seo_yuha', targetName: '서유하', thought: '절대적인 주군', quote: '내가 모셔야 할 유일한 주군. 그 어떤 위협으로부터도 안전하게 지켜내야 한다.' },
      { targetId: 'baek_hyunwoo', targetName: '백현우', thought: '경계 대상', quote: '행동이 불분명하고 의심스러운 자. 도련님께 해가 된다면 언제든 제거할 준비가 되어 있다.' },
      { targetId: 'jung_haewoon', targetName: '정해운', thought: '위험한 변수', quote: '속을 알 수 없는 미치광이. 도련님께 해가 될지도 모르는 위험한 변수다.' }
    ]
  },
  {
    id: 'baek_hyunwoo',
    ...
    ,
      'https://i.postimg.cc/gjdcZyBs/baeghyeon-u-1.png',
      'https://i.postimg.cc/6q0WL7ky/baeghyeon-u-2.png',
      'https://i.postimg.cc/44bxTMm6/baeghyeon-u-3.png',
      'https://i.postimg.cc/pVYLt7pD/baeghyeon-u-4.png',
      'https://i.postimg.cc/NG7jwV54/baeghyeon-u-5.png',
      'https://i.postimg.cc/sf9gR8v0/baeghyeon-u-6.png'
    ],
    themeSongName: '가짜 이름',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EB%B0%B1%ED%98%84%EC%9A%B0%20-%20%EA%B0%80%EC%A7%9C%20%EC%9D%B4%EB%A6%84.mp3',
    ...
    relationships: [
      { targetId: 'seo_yuha', targetName: '서유하', thought: '소름끼치는 놈', quote: '속을 알 수 없는 무서운 놈. 내 정체를 들킬까 봐 항상 피가 마르는 기분이다.' },
      { targetId: 'park_doyoung', targetName: '박도영', thought: '무서운 사냥개', quote: '서유하의 미친 사냥개. 저 무감각한 눈빛을 볼 때마다 소름이 끼친다.' },
      { targetId: 'jung_haewoon', targetName: '정해운', thought: '미친 좀비 박사', quote: '좀비에 미친 돌아이. 엮이면 명줄이 짧아질 게 분명해서 최대한 피하고 싶다.' }
    ]
  },
  {
    id: 'jung_haewoon',
    ...
    ,
      'https://i.postimg.cc/NG4BnHnf/jeonghaeun-1.png',
      'https://i.postimg.cc/QxYs8rs4/jeonghaeun-2.png',
      'https://i.postimg.cc/9FgVmjVL/jeonghaeun-3.png',
      'https://i.postimg.cc/mgnxZmyw/jeonghaeun-4.png',
      'https://i.postimg.cc/3Jf78H7z/jeonghaeun-5.png',
      'https://i.postimg.cc/bwGPdFNB/jeonghaeun-6.png'
    ],
    themeSongName: '기괴한 왈츠',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EC%A0%95%ED%95%B4%EC%9A%B4%20-%20%EA%B8%B0%EA%B4%B4%ED%95%9C%20%EC%99%88%EC%B8%A0.mp3',
    quote: '「좀비인가요? 해부하고 싶다! 😍」',
    info: [
      '나이: 22세',
      '신체: 184cm',
    ...
    secretInfo: [
      ...
      '상태: 정제된 소량의 좀비 바이러스를 투여받았으며, 식인 본능을 억누르기 위해 매일 아침 식욕억제제 복용',
      '과거: 한국대학교 생명공학과 출신'
    ],
    relationships: [
      { targetId: 'seo_yuha', targetName: '서유하', thought: '든든한 스폰서', quote: '나의 훌륭한 연구를 전폭적으로 지지해주는 최고의 스폰서! 덕분에 매일매일 실험이 즐겁다.' },
      { targetId: 'baek_hyunwoo', targetName: '백현우', thought: '재미있는 연구원 동료', quote: '나와 대화가 통하는 유일한 연구원 동료! 근데 왜 자꾸 나를 피하는 걸까? 🥺' },
      { targetId: 'zombie', targetName: '좀비', thought: '아름다운 실험체', quote: '완벽하고 아름다운 실험체. 전부 해부해보고 싶다.' }
    ]
  },
  {
    id: 'han_yoohwan',
    ...
    ,
      ...
      'https://i.postimg.cc/g2k7Vy8n/han-yuhwan-3.png',
      'https://i.postimg.cc/BQRS5GyP/han-yuhwan-4.png',
      'https://i.postimg.cc/NfZs8wVH/han-yuhwan-5.png',
      'https://i.postimg.cc/7Z7xmW83/han-yuhwan-6.png'
    ],
    ...
    relationships: [
      { targetId: 'lee_taeyoon', targetName: '이태윤', thought: '든든한 조력자', quote: '에덴을 함께 이끌어가는 든든하고 성숙한 동생. 마음 깊이 의지하고 있어.' },
      { targetId: 'tae_howon', targetName: '태호원', thought: '믿음직한 형', quote: '뛰어난 전투력을 가졌지만 짊어진 상처가 많은 형.' },
      { targetId: 'ha_namjin', targetName: '하남진', thought: '도와주고 싶은 녀석', quote: '입은 험하지만 속은 여린 녀석. 험악하고 위험한 곳에서 벗어나 우리와 함께했으면 좋겠어.' }
    ]
  },
  {
    id: 'lee_taeyoon',
    ...
    ,
      'https://i.postimg.cc/cJndkkpP/itaeyun-1.png',
      'https://i.postimg.cc/LXk22Y65/itaeyun-2.png',
      'https://i.postimg.cc/ydhssgYZ/itaeyun-3.png',
      'https://i.postimg.cc/DZQnnJy4/itaeyun-4.png',
      'https://i.postimg.cc/W3mTTFbJ/itaeyun-5.png',
      'https://i.postimg.cc/wv5ggyTw/itaeyun-6.png'
    ],
    themeSongName: '새싹',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EC%9D%B4%ED%83%9C%EC%9C%A4%20-%20%EC%83%88%EC%8B%B9.mp3',
    ...
    relationships: [
      { targetId: 'han_yoohwan', targetName: '한유환', thought: '존경하는 리더', quote: '맹목적일 정도로 타인을 돕는 이상주의자 리더. 무너지지 않게 곁에서 계속 도와야 한다.' },
      { targetId: 'tae_howon', targetName: '태호원', thought: '따뜻한 거인', quote: '겉보기엔 다가가기 힘든 위압적인 모습이지만, 내면은 누구보다 따뜻하고 여린 사람.' },
      { targetId: 'cheong_owol', targetName: '청오월', thought: '위험한 녀석', quote: '타인의 맹목적인 감정을 이용하고 유희거리로 삼는 불쾌하고 아주 위험한 자.' }
    ]
  },
  {
    id: 'tae_howon',
    ...
    ,
      'https://i.postimg.cc/brCXwQX1/taehowon-1.png',
      'https://i.postimg.cc/2j2NGfq5/taehowon-2.png',
      'https://i.postimg.cc/pVqMCt9h/taehowon-3.png',
      'https://i.postimg.cc/nV0f2ts9/taehowon-4.png',
      'https://i.postimg.cc/bY3fgjGy/taehowon-5.png',
      'https://i.postimg.cc/QxCGnn5t/taehowon-6.png'
    ],
    themeSongName: '사선 너머',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%ED%83%9C%ED%98%B8%EC%9B%90%20-%20%EC%82%AC%EC%84%A0%20%EB%84%88%EB%A8%B8.mp3',
    quote: '"...물러서. 위험하니까."',
    info: [
      '나이: 37세',
      '신체: 190cm',
    ...
    relationships: [
      { targetId: 'han_yoohwan', targetName: '한유환', thought: '나의 은인', quote: '나를 다시 사람답게 살게 해준 은인. 그가 그리는 이상을 위해 내 무력을 기꺼이 바칠 것이다.' },
      { targetId: 'lee_taeyoon', targetName: '이태윤', thought: '속 깊은 동생', quote: '어린 나이에도 묵묵히 제 몫을 다하며 헌신하는, 배울 점이 많은 녀석.' },
      { targetId: 'wife', targetName: '아내', thought: '내 삶의 전부', quote: '내가 숨을 쉬고 살아가는 유일한 목적이자 전부. 무슨 수를 써서라도 꼭 찾아낼 것이다.' }
    ]
  },
  {
    id: 'kim_yeonho',
    ...
    ,
      'https://i.postimg.cc/QNpHdCnq/gim-yeonho-1.png',
      'https://i.postimg.cc/zX83bNsr/gim-yeonho-2.png',
      'https://i.postimg.cc/wTg3yzCz/gim-yeonho-3.png',
      'https://i.postimg.cc/xTnqJQwf/gim-yeonho-4.png',
      'https://i.postimg.cc/65tT2Kkt/gim-yeonho-5.png',
      'https://i.postimg.cc/15BXDTS9/gim-yeonho-6.png'
    ],
    themeSongName: 'Price of Survival',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EA%B9%80%EC%97%B0%ED%98%B8%20-%20Price%20of%20Survival.mp3',
    ...
    relationships: [
      { targetId: 'ha_namjin', targetName: '하남진', thought: '쓸만한 파트너', quote: '까칠하고 다루기 힘들지만, 실력 하나는 확실한 비즈니스 파트너이자 츤데레 리더.' },
      { targetId: 'ha_namjun', targetName: '하남준', thought: '성가신 찌질이', quote: '능력도 없으면서 입만 살아있는 찌질이. 엮여봤자 이득 될 게 하나도 없어서 귀찮다.' },
      { targetId: 'sibling', targetName: '3계급 동생', thought: '살아가는 이유', quote: '내가 이 지옥 같은 세상에서 악착같이 구역질 나는 돈을 긁어모으며 살아남아야만 하는 유일한 이유.' }
    ]
  },
  {
    id: 'ha_namjin',
    ...
    ,
      'https://i.postimg.cc/vBX85xRN/hanamjin-1.png',
      'https://i.postimg.cc/SRvyv0xr/hanamjin-2.png',
      'https://i.postimg.cc/6qm9mspg/hanamjin-3.png',
      'https://i.postimg.cc/XqzVzMYD/hanamjin-4.png',
      'https://i.postimg.cc/2yKzKpSg/hanamjin-5.png',
      'https://i.postimg.cc/y6QYdRy3/hanamjin-6.png'
    ],
    themeSongName: '개새끼',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%ED%95%98%EB%82%A8%EC%A7%84%20-%20%EA%B0%9C%EC%83%88%EB%81%BC.mp3',
    ...
    relationships: [
      { targetId: 'ha_namjun', targetName: '하남준', thought: '혐오스러운 핏줄', quote: '나와 부모를 버리고 도망간 쓰레기 같은 핏줄. 마주치면 갈기갈기 찢어 죽여버리고 싶을 정도로 혐오스럽다.' },
      { targetId: 'kim_yeonho', targetName: '김연호', thought: '믿음직한 속물', quote: '돈밖에 모르는 속물 같지만, 이 바닥에서는 역설적으로 가장 계산이 확실해서 등 뒤를 맡길 만한 놈.' },
      { targetId: 'han_yoohwan', targetName: '한유환', thought: '성가신 성인군자', quote: '이 미친 세상에서 혼자 성인군자 노릇을 하는 등신. 호구 같아서 거슬리는데 자꾸 신경이 쓰인다.' }
    ]
  },
  {
    id: 'cheong_owol',
    ...
    ,
      'https://i.postimg.cc/7L0ynGz1/cheong-owol-1.png',
      'https://i.postimg.cc/hj0WNkp8/cheong-owol-2.png',
      'https://i.postimg.cc/G2jw6Wqz/cheong-owol-3.png',
      'https://i.postimg.cc/hj0WNkpb/cheong-owol-4.png',
      'https://i.postimg.cc/Kz5SC6Jq/cheong-owol-5.png',
      'https://i.postimg.cc/D0ykhxMB/cheong-owol-6.png'
    ],
    themeSongName: '데드 존의 홈런왕',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%EC%B2%AD%EC%98%A4%EC%9B%94%20-%20%EB%8D%B0%EB%93%9C%20%EC%A1%B4%EC%9D%98%20%ED%99%88%EB%9F%B0%EC%99%95.mp3',
    ...
    relationships: [
      { targetId: 'ha_namjun', targetName: '하남준', thought: '구역질 나는 벌레', quote: '징징거리는 꼴이 구역질 나는 버러지. 남자인 주제에 찌질하고 약한 척하는 게 제일 역겹다.' },
      { targetId: 'women', targetName: '여성 생존자', thought: '나의 구원', quote: '이 거칠고 더러운 세상에 남은 유일한 아름다움이자, 기꺼이 내가 베풀어야 할 자비의 대상들.' },
      { targetId: 'men', targetName: '남성 생존자', thought: '냄새나는 짐승들', quote: '생존에 하등 쓸모없고 시궁창 냄새만 나는 불쾌한 존재들. 내 눈앞에서 전부 치워버리고 싶다.' }
    ]
  },
  {
    id: 'ha_namjun',
    ...
    ,
      'https://i.postimg.cc/9Fk53tY5/hanamjun-1.png',
      'https://i.postimg.cc/mrQ0Hxxw/hanamjun-2.png',
      'https://i.postimg.cc/N01WHhhb/hanamjun-3.png',
      'https://i.postimg.cc/xdKWzrr6/hanamjun-4.png',
      'https://i.postimg.cc/g0vfZ99N/hanamjun-5.png',
      'https://i.postimg.cc/76wj1Bwz/hanamjun-6.png'
    ],
    themeSongName: '악명 높은 낙원',
    themeSongUrl: 'https://raw.githubusercontent.com/roog24/11/main/%ED%95%98%EB%82%A8%EC%A4%80%20-%20%EC%95%85%EB%AA%85%20%EB%86%92%EC%9D%80%20%EB%82%99%EC%9B%90.mp3',
    quote: '"크하하! 내가 바로 이 완벽한 신세계의 주인공이라고! ...히이익, 저리 가.!"',
    info: [
      '나이: 20세',
      '신체: 177cm',
      '성향: INFJ, 이기주의자, 소심함',
    ...
    secretInfo: [
      '본성: 구제불능의 나르시시스트이자 심각한 회피형, 자격지심으로 똘똘 뭉친 성격',
      '과거: 고졸 백수 히키코모리 애니메이션 오타쿠 출신으로, 좀비 사태 발발 시점에 가족을 버리고 비겁하게 혼자 도망침',
      '특이사항: 미쳐 돌아가는 좀비 세상을 오히려 반기며 악명 높고 잔혹하게 변함'
    ],
    relationships: [
      { targetId: 'ha_namjin', targetName: '하남진', thought: '남보다 못한 핏줄', quote: '항상 나보다 잘나서 내 자격지심을 자극하던 재수 없는 놈. 차라리 어디 가서 죽어버렸으면 좋겠다.' },
      { targetId: 'cheong_owol', targetName: '청오월', thought: '무서운 미친놈', quote: '눈 돌아가면 무슨 짓을 할지 모르는 진짜 미친놈. 어떻게든 비위라도 맞춰서 살아남아야 한다.' },
      { targetId: 'weak', targetName: '약한 생존자', thought: '내 먹잇감', quote: '이전 세상에선 나를 무시했겠지만, 이제는 내 밑창을 핥고 기어 다녀야 하는 약자.' }
    ]
  }
];
...
export const ZONES: Zone[] = [
  ...
  },
  {
    ...
    characterIds: ['han_yoohwan', 'lee_taeyoon', 'tae_howon', 'kim_yeonho', 'ha_namjin', 'cheong_owol', 'ha_namjun']
  },
  {
    id: 'future_lab',
    name: '미래 연구소',
